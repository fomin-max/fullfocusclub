            ...
            <div className={css.aboutContainerInner}>
              <div className={css.leftSide}>
                <Text format="m">
                  ...
                  игр, но и достичь любых вершин в киберспортивном мире. Наши
                  клубы имеют фирменный интерьер, который разработан с учетом
                  сочетания эргономичности и эффектности. Мы уделяем особое
                  внимание удобству каждого гостя, для этого все игровые места
                  оборудованы профессиональной периферией и железом, которое
                  позволит вам играть в любые игры на максимальных настройках.
                </Text>
              </div>
